...
public class StructureVillagePieces
{
    ...
    public static class House1 extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.setBlockState(worldIn, Blocks.glass_pane.getDefaultState(), 6, 2, 5, structureBoundingBoxIn);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 4, 1, 7, 4, 1, Blocks.radioactive_stone.getDefaultState(), Blocks.planks.getDefaultState(), false);
    ...
    public static class House2 extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 9, 0, 6, Blocks.radioactive_cobblestone.getDefaultState(), Blocks.cobblestone.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 0, 9, 4, 6, Blocks.radioactive_cobblestone.getDefaultState(), Blocks.cobblestone.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, 9, 5, 6, Blocks.antiradiations_insulator.getDefaultState(), Blocks.stone_slab.getDefaultState(), false);
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 1, 3, 5, 3, 3, Blocks.air.getDefaultState(), Blocks.planks.getDefaultState(), false);
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 1, 4, 9, 4, 6, Blocks.antiradiations_insulator.getDefaultState(), Blocks.cobblestone.getDefaultState(), false);
    ...
    public static class Path extends StructureVillagePieces.Road
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            IBlockState iblockstate = this.func_175847_a(Blocks.radioactive_cobblestone.getDefaultState());
    ...
    public static class Torch extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.setBlockState(worldIn, Blocks.antiradiations_insulator.getDefaultState(), 1, 3, 0, structureBoundingBoxIn);
        ...
        protected void spawnVillagers(World worldIn, StructureBoundingBox p_74893_2_, int p_74893_3_, int p_74893_4_, int p_74893_5_, int p_74893_6_)
        {
            if (this.villagersSpawned < p_74893_6_)
            {
                for (int i = this.villagersSpawned; i < p_74893_6_; ++i)
                {
                    ...
                    EntityVillagerMutante entityvillager = new EntityVillagerMutante(worldIn);
