...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            ...
            if (!list.isEmpty())
            {
                while (true)
                {
                    this.splashText = "Made by APC Team";
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 80, j + 95 - 40, 80, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 - 0, j + 95 - 40, 80, 20, I18n.format("menu.quit", new Object[0])));
        //this.buttonList.add(new GuiButtonLanguage(5, this.width / 10 + 97, j + 115 -40));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = "Apocalitticraft 0.4.2-20191208";
        ...
        String ilm ="Porte Aperte ISILTeP 13 dicembre 2019";
