...
import net.minecraft.client.model.ModelMob2a;
import net.minecraft.entity.passive.EntityMob2a;
import net.minecraft.client.model.ModelVillagerMutante;
...
public class RenderManager
{
    ...
    public RenderManager(TextureManager renderEngineIn, RenderItem itemRendererIn)
    {
        ...
        this.entityRenderMap.put(EntityMob2a.class, new RenderMob2a(this, new ModelMob2a(),0.7F));
        this.entityRenderMap.put(EntityVillagerMutante.class, new RenderVillagerMutante(this, new ModelVillagerMutante(),0.7F));
