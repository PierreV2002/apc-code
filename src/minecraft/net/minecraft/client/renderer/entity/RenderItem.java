...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    {
    	this.registerBlock(Blocks.antimatter_block, "antimatter_block");
    	this.registerBlock(Blocks.antimatter_ore, "antimatter_ore");
    	this.registerItem(Items.antimatter, "antimatter");
