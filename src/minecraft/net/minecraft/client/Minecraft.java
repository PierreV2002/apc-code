...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("textures/gui/title/apocalitticraft.png");
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        logger.info("-----------");
        logger.info("Version: 0.4.1-20191201");
        logger.info("=============================");
        this.setWindowIcon();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Apocalitticraft 0.4.1");
    ...
    public static Map<String, String> getSessionInfo()
    {
        ...
        map.put("X-Minecraft-Version", "2infa");
        return map;
    }
