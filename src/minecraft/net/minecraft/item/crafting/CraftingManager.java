...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        this.addShapelessRecipe(new ItemStack(Blocks.antimatter_block, 1), new Object[] {Items.antimatter, Items.antimatter, Items.antimatter,Items.antimatter,Items.antimatter,Items.antimatter,Items.antimatter,Items.antimatter,Items.antimatter});
        this.addShapelessRecipe(new ItemStack(Blocks.uranium_block, 1), new Object[] {Items.uranium, Items.uranium, Items.uranium,Items.uranium,Items.uranium,Items.uranium,Items.uranium,Items.uranium,Items.uranium});
        this.addShapelessRecipe(new ItemStack(Items.rutherfordio), new Object[] {Items.uranium, Items.uranium, Items.uranium, Items.uranium, Items.antimatter, Items.uranium, Items.uranium, Items.uranium, Items.uranium});
