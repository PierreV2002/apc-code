...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        registerItemBlock(Blocks.antimatter_ore);
        ...
        registerItem(432, "antimatter", (new Item()).setUnlocalizedName("antimater").setCreativeTab(CreativeTabs.tabMaterials));
        registerItem(433, "rutherfordio", (new ItemFood(0, 0F, false)).setPotionEffect(Potion.confusion.id , 60, 0, 1F).setUnlocalizedName("rutherfordio"));
        registerItem(434, "uranium", (new Item()).setUnlocalizedName("uranium").setCreativeTab(CreativeTabs.tabMaterials));
        
        registerItem(435, "antiradiazioni_maschera", (new ItemArmor(ItemArmor.ArmorMaterial.ANTIRADIAZIONI, 5, 0)).setUnlocalizedName("mascheraAntiradiazioni"));
        registerItem(436, "antiradiazioni_corazza", (new ItemArmor(ItemArmor.ArmorMaterial.ANTIRADIAZIONI, 5, 1)).setUnlocalizedName("corazzaAntiradiazioni"));
        registerItem(437, "antiradiazioni_gambali", (new ItemArmor(ItemArmor.ArmorMaterial.ANTIRADIAZIONI, 5, 2)).setUnlocalizedName("gambaliAntiradiazioni"));
        registerItem(438, "antiradiazioni_stivali", (new ItemArmor(ItemArmor.ArmorMaterial.ANTIRADIAZIONI, 5, 3)).setUnlocalizedName("stivaliAntiradiazioni"));
    }
