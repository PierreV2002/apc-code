...
public class BiomeDecorator
{
    ...
    protected WorldGenerator antimatterGen;
    ...
    public void decorate(World worldIn, Random random, BiomeGenBase p_180292_3_, BlockPos p_180292_4_)
    {
        ...
        else
        {
            ...
            this.antimatterGen = new WorldGenMinable(Blocks.antimatter_ore.getDefaultState(), this.chunkProviderSettings.antimatterSize);
            this.uraniumGen = new WorldGenMinable(Blocks.uranium_ore.getDefaultState(), this.chunkProviderSettings.uraniumSize);
    ...
    protected void generateOres()
    {
        ...
        this.genStandardOre1(this.chunkProviderSettings.antimatterCount, this.antimatterGen, this.chunkProviderSettings.antimatterMinHeight, this.chunkProviderSettings.antimatterMaxHeight);
        
        this.genStandardOre1(this.chunkProviderSettings.uraniumCount, this.uraniumGen, this.chunkProviderSettings.uraniumMinHeight, this.chunkProviderSettings.uraniumMaxHeight);
