...
public abstract class BiomeGenBase
{
    ...
    public static final BiomeGenBase plains = (new BiomeGenPlains(1)).setColor(9286496).setBiomeName("Bioma RadioAttivo");
    public static final BiomeGenBase desert = (new BiomeGenDesert(2)).setColor(16421912).setBiomeName("Deserto RadioAttivo").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setHeight(height_LowPlains);
    ...
    protected BiomeGenBase(int id)
    {
        ...
        this.spawnableCaveCreatureList.add(new BiomeGenBase.SpawnListEntry(EntityVillagerMutante.class, 1, 4, 4));
        this.spawnableCaveCreatureList.add(new BiomeGenBase.SpawnListEntry(EntityMob2a.class, 1, 4, 4));
