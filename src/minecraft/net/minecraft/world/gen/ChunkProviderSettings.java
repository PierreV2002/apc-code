...
public class ChunkProviderSettings
{
    ...
    public final int antimatterSize;
    public final int antimatterCount;
    public final int antimatterMinHeight;
    public final int antimatterMaxHeight;
    
    public final int uraniumSize;
    public final int uraniumCount;
    public final int uraniumMinHeight;
    public final int uraniumMaxHeight;
    ...
    private ChunkProviderSettings(ChunkProviderSettings.Factory settingsFactory)
    {
        ...
        this.antimatterSize = settingsFactory.andesiteSize;
        this.antimatterCount = settingsFactory.andesiteCount;
        this.antimatterMinHeight = settingsFactory.andesiteMinHeight;
        this.antimatterMaxHeight = settingsFactory.andesiteMaxHeight;
        
        this.uraniumSize = settingsFactory.andesiteSize;
        this.uraniumCount = settingsFactory.andesiteCount;
        this.uraniumMinHeight = settingsFactory.andesiteMinHeight;
        this.uraniumMaxHeight = settingsFactory.andesiteMaxHeight;
    }
    ...
    public static class Factory
    {
        ...
        public int antimatterSize = 8;
        public int antimatterCount = 10;
        public int antimatterMinHeight = 32;
        public int antimatterMaxHeight = 128;
        
        public int uraniumSize = 8;
        public int uraniumCount = 10;
        public int uraniumMinHeight = 32;
        public int uraniumMaxHeight = 128;
        ...
        public void func_177863_a()
        {
            ...
            this.antimatterSize = 8;
            this.antimatterCount = 10;
            this.antimatterMinHeight = 32;
            this.antimatterMaxHeight = 128;
            
            this.uraniumSize = 8;
            this.uraniumCount = 10;
            this.uraniumMinHeight = 32;
            this.uraniumMaxHeight = 128;
        }
        ...
        public int hashCode()
        {
            ...
            i = 31 * i + this.antimatterSize;
            i = 31 * i + this.antimatterCount;
            i = 31 * i + this.antimatterMinHeight;
            i = 31 * i + this.antimatterMaxHeight;
            
            i = 31 * i + this.uraniumSize;
            i = 31 * i + this.uraniumCount;
            i = 31 * i + this.uraniumMinHeight;
            i = 31 * i + this.uraniumMaxHeight;
            return i;
        }
    ...
    public static class Serializer implements JsonDeserializer<ChunkProviderSettings.Factory>, JsonSerializer<ChunkProviderSettings.Factory>
    {
        public ChunkProviderSettings.Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            ...
            try
            {
                ...
                chunkprovidersettings$factory.antimatterSize = JsonUtils.getInt(jsonobject, "antimatterSize", chunkprovidersettings$factory.antimatterSize);
                chunkprovidersettings$factory.antimatterCount = JsonUtils.getInt(jsonobject, "antimatterCount", chunkprovidersettings$factory.antimatterCount);
                chunkprovidersettings$factory.antimatterMinHeight = JsonUtils.getInt(jsonobject, "antimatterMinHeight", chunkprovidersettings$factory.antimatterMinHeight);
                chunkprovidersettings$factory.antimatterMaxHeight = JsonUtils.getInt(jsonobject, "antimatterMaxHeight", chunkprovidersettings$factory.antimatterMaxHeight);
                
                chunkprovidersettings$factory.uraniumSize = JsonUtils.getInt(jsonobject, "uraniumSize", chunkprovidersettings$factory.uraniumSize);
                chunkprovidersettings$factory.uraniumCount = JsonUtils.getInt(jsonobject, "uraniumCount", chunkprovidersettings$factory.uraniumCount);
                chunkprovidersettings$factory.uraniumMinHeight = JsonUtils.getInt(jsonobject, "uraniumMinHeight", chunkprovidersettings$factory.uraniumMinHeight);
                chunkprovidersettings$factory.uraniumMaxHeight = JsonUtils.getInt(jsonobject, "uraniumMaxHeight", chunkprovidersettings$factory.uraniumMaxHeight);
        ...
        public JsonElement serialize(ChunkProviderSettings.Factory p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
        {
            ...
            jsonobject.addProperty("antimatterSize", (Number)Integer.valueOf(p_serialize_1_.antimatterSize));
            jsonobject.addProperty("antimatterCount", (Number)Integer.valueOf(p_serialize_1_.antimatterCount));
            jsonobject.addProperty("antimatterMinHeight", (Number)Integer.valueOf(p_serialize_1_.antimatterMinHeight));
            jsonobject.addProperty("antimatterMaxHeight", (Number)Integer.valueOf(p_serialize_1_.antimatterMaxHeight));
            
            jsonobject.addProperty("uraniumSize", (Number)Integer.valueOf(p_serialize_1_.uraniumSize));
            jsonobject.addProperty("uraniumCount", (Number)Integer.valueOf(p_serialize_1_.uraniumCount));
            jsonobject.addProperty("uraniumMinHeight", (Number)Integer.valueOf(p_serialize_1_.uraniumMinHeight));
            jsonobject.addProperty("uraniumMaxHeight", (Number)Integer.valueOf(p_serialize_1_.uraniumMaxHeight));
