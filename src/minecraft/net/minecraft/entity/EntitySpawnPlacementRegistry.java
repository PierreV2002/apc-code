...
public class EntitySpawnPlacementRegistry
{
    ...
    static
    {
        ...
        ENTITY_PLACEMENTS.put(EntityMob2a.class, EntityLiving.SpawnPlacementType.ON_GROUND);
        ENTITY_PLACEMENTS.put(EntityVillagerMutante.class, EntityLiving.SpawnPlacementType.ON_GROUND);
